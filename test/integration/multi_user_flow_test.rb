...
class MultiUserFlowTest < ActionDispatch::IntegrationTest
  test "end to end user flow: registration, lobby interaction, word submission limit, and profile" do
    # 1. User registration
  ...
  test "admin can edit lobby and lock is released" do
    ...
    # Update lobby and verify lock is cleared
