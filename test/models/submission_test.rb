...
class SubmissionTest < ActiveSupport::TestCase
  test "valid submission belongs to user and lobby" do
    submission = Submission.new(user: users(:damian_user), lobby: lobbies(:second_lobby), word: "Framework")
    assert submission.valid?
  end

  test "word cannot be blank" do
    submission = Submission.new(user: users(:damian_user), lobby: lobbies(:second_lobby), word: "")
